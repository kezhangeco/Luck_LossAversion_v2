...
class instructionPage2():
    ...
    def __init__(self, master):
        ...
        explanation5="""After you have made your choice, the outcome will be shown to you."""
...
class practisePage1():
    ...
    def __init__(self, master):
        ...
        self.questionCoverBlockEx = self.w.create_rectangle(0, 660, 1300, 50, outline= "white", fill='white')
        self.w.itemconfigure(self.questionCoverBlockEx, state='hidden')

        self.lostState1 = self.w.create_text(self.middleX, 0.15 * self.height, text='YOU  LOSE  $1', font="Helvetica 36 bold",
                                             anchor=N, state="hidden")
        self.lostState2 = self.w.create_text(self.middleX, 0.15 * self.height, text='YOU  LOSE  $3', font="Helvetica 36 bold",
                                             anchor=N, state="hidden")
    ...
    ###cue###
        pygame.mixer.init()
        self.loss_sound = pygame.mixer.music.load("/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/sounds/loss/Trimed/2_matched.wav")

        imgFile1 = Image.open('/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/images/c1_loss_rs.png')
        self.loss1_image = ImageTk.PhotoImage(imgFile1)


    def showResultEx1(self, event = None):
        self.w.itemconfigure(self.confRec_c1, state = 'normal')
        t = Timer(1, self.showResultEx1_s2)
        t.start()
        self.master.unbind("<z>", self.choiceA)
        self.master.unbind("<m>", self.choiceB)

    def showResultEx1_s2(self):
        self.w.itemconfigure(self.confRec_c1, state = 'hidden')
        self.w.itemconfigure(self.questionCoverBlockEx, state='normal', fill='white')
        self.w.itemconfigure(self.lostState1, state="normal")

        # sound#
        self.sound = self.loss_sound
        pygame.mixer.music.play()

        # image#
        self.image = self.w.create_image(653, 384, image=self.loss1_image, anchor='center')

        t = Timer(2, self.showButtonInst3)
        t.start()

    def showResultEx2(self, event=None):
        self.w.itemconfigure(self.confRec_c2, state = 'normal')
        t = Timer(1, self.showResultEx2_s2)
        t.start()
        self.master.unbind("<m>", self.choiceB)
        self.master.unbind("<z>", self.choiceA)


    def showResultEx2_s2(self):
        self.w.itemconfigure(self.confRec_c2, state = "hidden")
        self.w.itemconfigure(self.questionCoverBlockEx, state='normal', fill='white')
        self.w.itemconfigure(self.lostState2, state="normal")
...
class practisePage2():
    ...
    def __init__(self, master):
        ...
        self.winState1 = self.w.create_text(middleX, 0.15 * self.height, text='YOU  WIN  $36', font="Helvetica 36 bold",
                                            anchor=N, state="hidden")

        self.winState2 = self.w.create_text(middleX, 0.15 * self.height, text='YOU  WIN  $21', font="Helvetica 36 bold",
                                           anchor=N, state="hidden")

        ###cues###
        pygame.mixer.init()
        self.win_sound = pygame.mixer.music.load("/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/sounds/wins/coin2_matched.wav")

        imgFile5 = Image.open('/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/images/c5_rs.png')
        self.win5_image = ImageTk.PhotoImage(imgFile5)
    ...
    def showResultEx1_s2(self):
        self.w.itemconfigure(self.confRec_c1, state = 'hidden')
        self.w.itemconfigure(self.questionCoverBlockEx, state='normal', fill='white')
        self.w.itemconfigure(self.winState1, state="normal")

        # sound#
        self.sound = self.win_sound
        pygame.mixer.music.play()

        # image#
        self.image = self.w.create_image(653, 384, image=self.win5_image, anchor='center')
    ...
    def showResultEx2_s2(self):
        self.w.itemconfigure(self.confRec_c2, state='hidden')
        self.w.itemconfigure(self.questionCoverBlockEx, state='normal', fill='white')
        self.w.itemconfigure(self.winState2, state="normal")
...
class practisePage3():
    ...
    def __init__(self, master):
        ...
        self.winState1 = self.w.create_text(middleX, 0.15 * height, text='YOU  WIN  $6', font="Helvetica 36 bold",
                                            anchor=N, state="hidden")

        self.winState2 = self.w.create_text(middleX, 0.15 * height, text='YOU  GET  $0', font="Helvetica 36 bold",
                                            anchor=N, state="hidden")
        ...
        imgFile2 = Image.open('/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/images/c2_rs.png')
        self.win2_image = ImageTk.PhotoImage(imgFile2)
        imgFile1 = Image.open('/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/images/c1_rs.png')
        self.win1_image = ImageTk.PhotoImage(imgFile1)
    ...
    def showResultEx1_s2(self):
        ...
        # image#
        self.image = self.w.create_image(653, 384, image=self.win2_image, anchor='center')
    ...
    def showResultEx2_s2(self):
        ...
        # image#
        # self.image = self.w.create_image(653, 384, image=self.win1_image, anchor='center')
...
#for loop, repeat the equations#
    ...
    def __init__(self, master, csv_name_ses, csv_name_sub):
        ...
        self.resultFile = open(
            "/Users/kezhang/Desktop/Luck_LossAversion_v2/Results/results_staircase/with_outcome_staircase/" + self.csv_name_sub + '_' + self.csv_name_ses +
        ...
        #button: location of buttons#
        #self.button1 = Button(self.master, text="Choice A", command=self.run1, anchor=W)
        #self.button1.configure(width=10, activebackground="#33B5E5", relief=FLAT)
        #self.button1.place_configure(relx=0.25, rely=0.85, anchor=S)
        #self.button1.lower()
        self.choiceA = self.master.bind('z', self.run1)

        #self.button2 = Button(self.master, text="Choice B", command=self.run2, anchor=W)
        #self.button2.configure(width=10, activebackground="#33B5E5", relief=FLAT)
        #self.button2.place_configure(relx=0.75, rely=0.85, anchor=S)
        #self.button2.lower()
...
#####cues####
        ...
        imgFile3 = Image.open('/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/images/c3_rs.png')
        self.win3_image = ImageTk.PhotoImage(imgFile3)

        imgFile4 = Image.open('/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/images/c4_rs.png')
        self.win4_image = ImageTk.PhotoImage(imgFile4)

        imgFile5 = Image.open('/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/images/c5_rs.png')
        self.win5_image = ImageTk.PhotoImage(imgFile5)

        # if loss image#
        imgFile6 = Image.open('/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/images/c1_loss_rs.png')
        self.loss1_image = ImageTk.PhotoImage(imgFile6)

        imgFile7 = Image.open('/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/images/c2_loss_rs.png')
        self.loss2_image = ImageTk.PhotoImage(imgFile7)

        imgFile8 = Image.open('/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/images/c3_loss_rs.png')
        self.loss3_image = ImageTk.PhotoImage(imgFile8)

        imgFile9 = Image.open('/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/images/c4_loss_rs.png')
        self.loss4_image = ImageTk.PhotoImage(imgFile9)

        imgFile10 = Image.open('/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/images/c5_loss_rs.png')
        self.loss5_image = ImageTk.PhotoImage(imgFile10)
    ...
    def clickPostProcess(self):
        ...
        # elif self.isPure:
        #     self.q_index = random.randrange(0, 2 * self.questionNumber, 1)
        #     # pick 1 from first 10 questions
        #
        #
        # elif self.isMixed1:
        #     self.q_index = random.randrange(2 * self.questionNumber, 3 * self.questionNumber, 1)
        #     # pick 1 from 10 to 15 questions
        #
        # elif self.isMixed2:
        #     self.q_index = random.randrange(3 * self.questionNumber, 4 * self.questionNumber, 1)
        #     # pick 1 from 15 to 20 questions
        #
        # else:
        #     self.q_index = random.randrange(4 * self.questionNumber, 5 * self.questionNumber, 1)
        #     # pick 1 from 20 to 25 questions. Each question is a package of iterations, which do not need specification
        #     #here.
    ...
    def computerChoose(self, human_choice):
        if human_choice is True: ## human choice is B, 100%##
            ...
            if self.value > 0:
                self.computer_choice_label['text'] = 'YOU  WIN  $' + str(abs(self.value))
                self.computer_choice_label['font'] = 'Helvetica 36 bold'
                self.computer_choice_label.place(relx=0.5, rely=0.2, anchor=CENTER)
            elif self.value < 0:
                self.computer_choice_label['text'] = 'YOU  LOSE $' + str(abs(self.value))
                self.computer_choice_label['font'] = 'Helvetica 36 bold'
                self.computer_choice_label.place(relx=0.5, rely=0.2, anchor=CENTER)

            else:
                self.computer_choice_label['text'] = 'YOU  GET  $0'
                self.computer_choice_label['font'] = 'Helvetica 36 bold'
                self.computer_choice_label.place(relx=0.5, rely=0.2, anchor=CENTER)
    ...
    def image_effect(self):
        ...
        if 0<self.value<6:
            self.image = self.w.create_image(653, 384, image=self.win1_image, anchor='center')
        elif 6<=self.value<12:
            self.image = self.w.create_image(653, 384, image=self.win2_image, anchor='center')
        elif 12<=self.value<18:
            self.image = self.w.create_image(653, 384, image=self.win3_image, anchor='center')
        elif 18<=self.value<24:
            self.image = self.w.create_image(653, 384, image=self.win4_image, anchor='center')
        elif 24 <= self.value:
            self.image = self.w.create_image(653, 384, image=self.win5_image, anchor='center')
            ...
            self.image = self.w.create_image(653, 384, image=self.loss2_image, anchor='center')
        elif -12 >= self.value > -18:
            self.image = self.w.create_image(653, 384, image=self.loss3_image, anchor='center')
        elif -18 >=self.value >-24:
            self.image = self.w.create_image(653, 384, image=self.loss4_image, anchor='center')
        elif -24 >= self.value:
            self.image = self.w.create_image(653, 384, image=self.loss5_image, anchor='center')
        else:
            pass
    ...
    def sound_effect(self):
        #sound effect
        if self.value < 0:
            print("self.value for sound loss ", self.value)
            pygame.mixer.init()
            self.loss_sound = pygame.mixer.music.load("/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/sounds/loss/Trimed/2_matched.wav")
            pygame.mixer.music.play()
        elif self.value > 0:
            print("self.value for sound win ", self.value)
            pygame.mixer.init()
            self.win_sound = pygame.mixer.music.load("/Users/kezhang/Desktop/Luck_LossAversion_v2/cues/sounds/wins/coin2_matched.wav")
            pygame.mixer.music.play()
    ...
    def clearResult(self):
        ...
        self.w.itemconfigure(self.image, state='hidden')
...
#for loop, repeat the equation
    ...
    def __init__(self, master, csv_name_ses, csv_name_sub, algorithmIndex, initX, mid_loss_list, mid_gain_list):
        ...
        self.resultFile = open("/Users/kezhang/Desktop/Luck_LossAversion_v2/Results/results_matrix/with_outcome_matrix/" + self.csv_name_sub + '_' + self.csv_name_ses +
            '_outcome_matrix_results.csv', 'w')
        self.resultFileWrite = csv.writer(self.resultFile)
        self.resultFileWrite.writerow(
            ['trial','v_50_1', 'v_50_2', 'v_100', 'subject choice', 'computer choice', 'rt(ms)'])
